...
public class JdiElementsPage extends BaseJdiPage {
    ...
    public void selectYellowDropdownOption() {
        ...
        verifyDropdownElementsLog();
        softAssert.assertAll();
    }

    private void verifyWaterCheckboxLog() {
    ...
    private void verifyWindCheckboxLog() {
    ...
    private void verifySelenRadiobuttonLog() {
    ...
    private void verifyDropdownElementsLog() {
